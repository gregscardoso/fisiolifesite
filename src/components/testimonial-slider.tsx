...
export function TestimonialSlider() {
  ...
  return <div className="testimonials-content">
    ...
    <div className="testimonial-viewport"><div className="testimonial-track" style={{ "--slide": index } as React.CSSProperties}>
      ...
      <article className="feedback-card"><h3>Sua voz é fundamental para o nosso crescimento.</h3><p>Já é paciente da Fisiolife? Conte como foi a sua experiência — isso ajuda outras pessoas a darem o primeiro passo.</p><a href={siteConfig.feedbackUrl} target="_blank" rel="noopener noreferrer">Deixar meu feedback</a></article>
    </div></div>
  </div>;
}
