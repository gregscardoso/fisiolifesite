      ...
      <div className="footer-grid shell">
        <div>
          ...
          <div className="socials">
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp da Fisiolife"><WhatsApp /></a>
            <a href={contact.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram da Fisiolife"><Instagram /></a>
          </div>
        </div>
        ...
        <div className="footer-column"><h3>Contato</h3><div className="footer-links contact-links"><a href={`tel:${contact.phone}`}>{contact.phoneDisplay}</a><a href={`mailto:${contact.email}`}>{contact.email}</a><span>{contact.address}<br />{contact.city}</span></div></div>
      </div>
      <div className="footer-bottom shell"><span>© 2026 Fisiolife Fisioterapia &amp; Pilates — Todos os direitos reservados.</span><span>Desenvolvido por <a href="https://gregorycardoso.com.br/" target="_blank" rel="noopener noreferrer">Gregory Cardoso</a>.</span></div>
    </footer>
  );
}
